                            ...
                            <div class="flex h-[60vh] flex-col gap-2 overflow-auto max-md:px-[10px] md:gap-5 p-6 bg-white">
                                <div
                                    ...
                                    <div
                                        ...
                                        <h3 class="font-bold text-3xl text-dark max-sm:text-2xl max-lg:text-2xl tracking-[-0.75px]">I'm Joy, here to help you figure out which <span class="text-secondary">home</span> to buy.</h3>
                                        <button
                                            @click="updateStep(1)"
                                            class="inline-block bg-[#F7F7F7] mt-14 max-md:mt-6 px-20 py-4 rounded-[40px] w-80 max-lg:w-auto font-normal text-[15px] text-primary hover:text-dark">Start</button>
                                    </div>
                                    <div
                                        v-if="step == 2"
                                        class="font-dm-sans text-center">
                                ...
                                <div
                                    v-else
                                    class="relative flex flex-col justify-center items-center gap-7 bg-white px-20 max-lg:px-10 pt-40 pb-10 rounded-[30px] max-w-[90vw] h-[586px] max-lg:h-auto max-h-[90vh] overflow-auto scrollbar-hide">
            ...
            methods: {
                ...
                async getAttributeOptionDetails(code){
                    this.$axios.get("{{ route('enclaves.api.attribute', '') }}/" + code)
                        .then(response => {
                            console.log(this.step, response);
