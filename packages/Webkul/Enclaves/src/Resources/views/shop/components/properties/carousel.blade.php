...
@pushOnce('scripts')
    <script type="text/x-template" id="v-properties-carousel-template">
        ...
        <section
            ...
            >
            <div class="container">
                <h2 class="text-center text-3xl font-bold text-dark max-sm:text-2xl">Our Brands</h2>
                        ...
                        <div class="mx-auto mt-7 w-[302px] max-sm:w-[280px]">
                            ...
                            <div class="mt-7 flex gap-4">
                                ...
                                <ul class="list-inside list-disc">
                                    <li class="text-lg font-normal text-[#343064] max-sm:text-base">House & Lot</li>
                                    <li class="text-lg font-normal text-[#343064] max-sm:text-base">Condominium</li>
                                </ul>
                            </div>
                        </div>
