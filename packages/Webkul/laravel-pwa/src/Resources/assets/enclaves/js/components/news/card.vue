<template>
	<div class="slide-card w-[155px]" >
		<img :src="news.base_image" alt="Affiliate Marketer" class="w-full rounded-[20px]">
		<p class="mt-3 text-[14px] font-bold text-dark">{{truncateText(stripTags(news.short_description))}}</p>
