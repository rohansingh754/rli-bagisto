<template>
		...
		<div class="container">
			<div class="font-popins flex justify-start">
				<div class="flex items-center gap-x-[10px]">
					...
					<p class="flex items-center gap-x-[10px] text-[12px] font-medium text-dark">Elanvital <span
							class="icon-arrow-right text-[10px] font-extrabold"></span></p>
					<p class="text-[12px] font-medium text-text-gray">Agapeya</p>
				</div>
			</div>
		</div>
	 </section>
    ...
    <section class="mt-3">
        <div class="container">
            <div class="flex items-center justify-between gap-4 rounded-[20px] border border-[#D9D9D9] px-5 py-2 max-385:gap-2 max-385:px-3">
                ...
                <img :src="themeAssets + 'images/agapeya-product.png'" alt="" class="max-w-[102px]">
	  ...
	  <section class="product-slider mt-5">
		<div class="homeful-slider-wrap relative mt-4">
			<div class="homeful-slide active">
				<img :src="sliderActiveImage.large_image_url" alt="Facade" class="w-full">
			</div>
		</div>
		<div
            v-if="product"
	 ...
	 <section class="mt-7" v-if="product">
		<div class="container">
			...
			<p class="mt-5 border-b border-[#D9D9D9] pb-5 text-[15px] font-normal text-dark">
	...
	<div class="fixed inset-x-0 bottom-0 z-50 flex items-center justify-center gap-7 bg-white p-6">
		<a href="#" class="flex flex-col items-center gap-1 text-[12px] font-normal text-[#8B8B8B]">
			<span>
